    ...
    <main class="page">
      ...
      <section class="section light">
        <div class="section-head">
          ...
          <p>Each event card sends players, managers, families, and supporters to the next useful step: details, team entry, spectator tickets, travel, or tournament profiles.</p>
        </div>
      ...
      <section class="section olive">
        <div class="section-head">
          <div>
            ...
            <h2>All rugby surfaces</h2>
          </div>
          <p>Rugbymonkey is shaped around real search behavior: tournament format, destination, division, team level, and what a manager can actually do next.</p>
        </div>
        <div class="grid four">
      ...
      <section class="section light">
        <div class="section-head">
          ...
          <p>Profiles connect events to the rugby people and organizations around them: tournament operators, national squads, touring clubs, sevens players, and team managers.</p>
        </div>
    ...
    <main class="page">
      ...
      <section class="section light">
        <div class="section-head">
          ...
          <p>Use this page when the visitor already knows they want to act: enter a team, buy tickets, check VIP, or continue to event details.</p>
        </div>
...
function submitPage() {
  return `
    <main class="page">
      ${pageHero("Submit a tournament", "Send a rugby event for calendar coverage, team discovery, ticket links, divisions, media, and future event pages.", button("Email tournament details", "mailto:events@rugbymonkey.com?subject=Tournament%20submission", "primary", icons.external), imageFor("algarve-7s", 8))}
      <section class="section light">
        <div class="split">
          ...
          <aside class="panel-card">
            <h3>Good tournament pages include</h3>
            <p>Date, venue, format, age grade, gender divisions, team entry, ticket route, travel notes, parking, media, organizer contact, and links to related profiles.</p>
            <div class="chip-list">
...
function teamsPage() {
  return `
    <main class="page">
      ${pageHero("Teams and rugby communities", "Find national squads, club teams, touring sides, university programs, and team-manager profiles connected to the events they are likely to enter or follow.", button("Register team", "/register", "primary") + button("Profiles", "/profiles", "secondary"), imageFor("alaska-midnight-sun-7s", 9))}
      <section class="section light">
