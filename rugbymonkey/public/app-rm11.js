...
import { tenant } from "./data/tenant-rm11.js";
    ...
    <main class="page">
      ...
      <section class="section light">
        <div class="section-head compact-head">
          ...
          ${button("Full calendar", "/events?status=upcoming", "secondary")}
        </div>
...
function filterBar(state, defaultCode = "") {
  ...
  const clearHref = ["/sevens", "/fifteens", "/beach", "/touch"].includes(currentPath()) ? currentPath() : "/events";
  return `
